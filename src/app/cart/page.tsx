...
export default function CartPage() {
  ...
  const handleCheckout = (e: React.FormEvent) => {
    ...
    const whatsappNumber = '923075597125'; // 0307-5597125 converted to intl format assuming PK +92
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-24">
              ...
              <form onSubmit={handleCheckout} className="space-y-4">
                ...
                <div className="pt-4 border-t mt-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white py-3.5 px-4 rounded-xl font-bold flex justify-center items-center gap-2 transition-colors active:scale-95 shadow-md"
                  >
